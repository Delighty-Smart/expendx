    ...
    <Card className="p-4 glass-card hover:shadow-md transition-shadow">
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-sm">
          ...
          <span className="font-medium">{currency.symbol}{formatAmount(budget.amount)}</span>
        </div>
        <BudgetProgress category={budget.category} budgetAmount={budget.amount} />
      </div>
    </Card>
  );
};
...
const BudgetsPage = () => {
  ...
  }, [budgetToDelete, queryClient, supabase, toast]);
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold">
                  {currency.symbol}
                  {formatAmount(budgets?.reduce((sum, budget) => sum + budget.amount, 0) || 0)}
                </p>
              </div>
            </div>
          </Card>
