        ...
        <Card className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Select value={currency.code} onValueChange={handleCurrencyChange}>
                ...
                <SelectContent className="bg-[#f6f6f6]/[0.86]">
                  {filteredCurrencies.map(c => <SelectItem key={c.code} value={c.code} className="hover:bg-accent">
                      {c.name} ({c.symbol})
                    </SelectItem>)}
                </SelectContent>
              </Select>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Button variant={theme === "light" ? "default" : "outline"} className="flex items-center gap-2" onClick={() => handleThemeChange("light")}>
                <Sun className="h-4 w-4" />
                Light Mode
              </Button>
              <Button variant={theme === "dark" ? "default" : "outline"} className="flex items-center gap-2" onClick={() => handleThemeChange("dark")}>
