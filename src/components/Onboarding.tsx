    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5 flex items-center justify-center p-4">
      ...
      <Card className="relative w-full max-w-lg shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
        ...
        <CardContent className="px-8 pb-8">
          ...
          <div className={`text-center mb-8 p-6 rounded-2xl bg-gradient-to-br ${steps[activeStep].gradient}`}>
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <Button 
              onClick={handleNext}
              disabled={isProcessing}
              className="px-8 py-3 bg-primary hover:bg-primary/90 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2"
            >
              {isProcessing ? (
                <>
