  ...
  return <div className="min-h-screen bg-background transition-colors duration-300">
    ...
    <aside className={`fixed top-0 left-0 h-full w-[280px] md:w-64 bg-card border-r border-border transform transition-all duration-300 ease-in-out z-40 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 flex flex-col shadow-lg`}>
      ...
      <div className="border-t border-border mt-auto p-1.5">
        <div className="flex items-center gap-2 p-1.5 rounded-xl hover:bg-accent/50 cursor-pointer transition-all duration-200 group touch-manipulation" onClick={handleProfileClick}>
          <UserAvatar
          ...
          <Button variant="ghost" size="icon" onClick={e => {
            e.stopPropagation();
            handleLogout();
          }} className="h-7 w-7 text-muted-foreground hover:text-red-500 hover:bg-red-500/10 rounded-lg transition-colors ml-auto">
