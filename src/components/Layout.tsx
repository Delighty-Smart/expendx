...
const Layout = ({
  ...
  return <div className="min-h-screen bg-background transition-colors duration-300">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-sidebar-background border-b border-border flex items-center justify-between px-4 z-50">
        ...
        <h1 className="text-lg font-semibold text-sidebar-foreground">BudgeX</h1>
      </header>
      ...
      {/* Main Content */}
      <main className={`pt-16 lg:pl-64 min-h-screen transition-all duration-300 ${isSidebarOpen ? "brightness-50 lg:brightness-100" : ""}`} onClick={() => setIsSidebarOpen(false)}>
