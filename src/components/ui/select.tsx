  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content 
      ...
      className={cn(
        ...
        "bg-background/95 backdrop-blur-sm scrollable-container",
        className
      )} 
      position={position} 
      {...props}
    >
      ...
      <SelectPrimitive.Viewport 
        className={cn(
          ...
          // Added extra padding for better touch targets and smooth scrolling
          "p-2 max-h-[40vh] sm:max-h-[50vh] scroll-smooth -webkit-overflow-scrolling-touch overscroll-contain"
        )}
      >
        {children}
      </SelectPrimitive.Viewport>
